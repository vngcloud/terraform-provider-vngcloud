...
func ResourcePostgreSQLCLusterConfigurationGroup() *schema.Resource {
	return &schema.Resource{
		Create: resourcePostgreConfigurationGroupCreate,
		Read:   resourcePostgreConfigurationGroupRead,
		Delete: resourcePostgreConfigurationGroupDelete,
		Update: resourcePostgreConfigurationGroupUpdate,
...
func resourcePostgreConfigurationGroupCreate(d *schema.ResourceData, m interface{}) error {
	...
	err := resourcePostgreConfigurationGroupUpdate(d, m)
	if err != nil {
		return err
	}
	time.Sleep(10 * time.Second)

	return resourcePostgreConfigurationGroupRead(d, m)
}

func resourcePostgreConfigurationGroupRead(d *schema.ResourceData, m interface{}) error {
...
func resourcePostgreConfigurationGroupDelete(d *schema.ResourceData, m interface{}) error {
	...
	stateConf := &resource.StateChangeConf{
		...
		Refresh:    resourcePostgreConfigGroupDeleteStateRefreshFunc(cli, d.Id()),
...
func resourcePostgreConfigurationGroupUpdate(d *schema.ResourceData, m interface{}) error {
	cli := m.(*client.Client)
...
func resourcePostgreConfigGroupDeleteStateRefreshFunc(cli *client.Client, configId string) resource.StateRefreshFunc {
