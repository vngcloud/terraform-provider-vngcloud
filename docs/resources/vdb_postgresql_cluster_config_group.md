...
subcategory: "vDB"
page_title: "vngcloud_vdb_postgresql_cluster_config_group Resource - terraform-provider-vngcloud"
description: |-
  Provides a VNG Cloud vDB PostgreSQL Cluster Configuration group. This can be used to import, create, modify, and delete.
  
---

# vngcloud_vdb_postgresql_cluster_config_group (Resource)
...
```terraform
resource "vngcloud_vdb_postgresql_cluster_config_group" "postgre_cluster_17_config" {
  engine_version = "17"
  name = "tf-postgre-cluster-17"
  values = {
    "autovacuum" = "true",
    "max_connections" = "100"
  }
