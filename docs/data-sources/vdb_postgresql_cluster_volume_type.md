...
subcategory: "vDB"
page_title: "vngcloud_vdb_postgresql_cluster_volume_type Data Source - terraform-provider-vngcloud"
description: |-
  Provides a VNG Cloud vDB PostgreSQL Cluster Volume type.

---

# vngcloud_vdb_postgresql_cluster_volume_type (Data Source)
...
```terraform
data "vngcloud_vdb_postgresql_cluster_volume_type" "Gen2_NVMe_IOPS5000" {
