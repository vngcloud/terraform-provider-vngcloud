...
// APIClient manages communication with the Api Documentation API v1.0.5
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.PersistentVolumeRestControllerApi = (*PersistentVolumeRestControllerV2ApiService)(&c.common)
