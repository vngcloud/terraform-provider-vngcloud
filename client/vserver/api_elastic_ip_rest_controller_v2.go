...
/*
ElasticIpRestControllerV2ApiService List elastic-ip
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param projectId The project id
 * @param optional nil or *ElasticIpRestControllerV2ApiListElasticIpUsingGETOpts - Optional Parameters:
     * @param "Name" (optional.String) -  name
     * @param "Page" (optional.Int32) -  page
     * @param "Size" (optional.Int32) -  size

@return PagingElasticIpDetail
*/
...
func (a *ElasticIpRestControllerV2ApiService) ListElasticIpUsingGET(ctx context.Context, projectId string, localVarOptionals *ElasticIpRestControllerV2ApiListElasticIpUsingGETOpts) (PagingElasticIpDetail, *http.Response, error) {
	var (
		...
		localVarReturnValue PagingElasticIpDetail
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v2/{projectId}/elastic-ips"
