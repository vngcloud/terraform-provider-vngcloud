...
/*
ServerRestControllerV2ApiService Auto Attach Wan IP (create new floating IP and attach to interface)
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param attachDetachWanIPRequest attachDetachWanIPRequest
  - @param projectId The project id
  - @param serverId The server id
*/
func (a *ServerRestControllerV2ApiService) AutoAttachWanIPUsingPUT(ctx context.Context, attachDetachWanIPRequest AttachDetachWanIpRequest, projectId string, serverId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v2/{projectId}/servers/{serverId}/wan-ips/auto/attach"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", fmt.Sprintf("%v", projectId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"serverId"+"}", fmt.Sprintf("%v", serverId), -1)
...
func (a *ServerRestControllerV2ApiService) AttachNetworkInterfaceWithWanIpUsingPOST(ctx context.Context, attachNetworkInterfaceWithWanIpRequest AttachNetworkInterfaceWithWanIpRequest, serverId string, projectId string) (DataResponseInterfaceNetworkInterface, *http.Response, error) {
	...
	// body params
	localVarPostBody = &attachNetworkInterfaceWithWanIpRequest
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (a *ServerRestControllerV2ApiService) DetachNetworkInterfaceWithWanIpUsingDELETE(ctx context.Context, detachNetworkInterfaceWithWanIpRequest DetachNetworkInterfaceWithWanIpRequest, projectId string, serverId string) (*http.Response, error) {
	...
	// body params
	localVarPostBody = &detachNetworkInterfaceWithWanIpRequest
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)
	if err != nil {
		return nil, err
	}
