...
# **CreatePoolUsingPOST**
> DataResponsePool CreatePoolUsingPOST(ctx, createPoolRequestV2, loadBalancerId, projectId)
Create a new pool
...
> DeletePoolUsingDELETE(ctx, poolId, projectId)
Delete a pool
...
> map[string]string UpdateMembersUsingPUT(ctx, poolId, projectId, updateMembersRequestV2)
Update list members
...
# **UpdatePoolUsingPUT**
> DataResponsePool UpdatePoolUsingPUT(ctx, poolId, projectId, updatePoolRequestV2)
Update a pool
