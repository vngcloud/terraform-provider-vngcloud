...
type DatabaseInstancesGateway struct {
	...
	PrivateRwIp          string                   `json:"privateRwIp,omitempty"`
	PublicRwIp           string                   `json:"publicRwIp,omitempty"`
	PrivateRoIp          string                   `json:"privateRoIp,omitempty"`
	PublicRoIp           string                   `json:"publicRoIp,omitempty"`
	EnableProxies        bool                     `json:"enableProxies,omitempty"`
	PoolMaxConnections   int32                    `json:"poolMaxConnections,omitempty"`
	VolumeTypeId         string                   `json:"volumeTypeId,omitempty"`
	DomainName           string                   `json:"domainName,omitempty"`
	PortRo               int32                    `json:"portRo,omitempty"`
}
