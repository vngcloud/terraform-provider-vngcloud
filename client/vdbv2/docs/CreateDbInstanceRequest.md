...
------------ | ------------- | ------------- | -------------
**User** | [***UserRequest**](UserRequest.md) |  | [optional] [default to null]
**Databases** | [**[]DatabaseRequest**](DatabaseRequest.md) | Database information. Currently support 1 database at creation. | [optional] [default to null]
**Name** | **string** | DB instance name | [optional] [default to null]
**VolumeType** | **string** | Volume type | [optional] [default to null]
...
**PackageId** | **string** | Flavor ID | [optional] [default to null]
