...
type V1ClusterControllerApiV1ClustersClusterIdPatchAutoHealingConfigOpts struct {
	Body         optional.Interface
	PortalUserId optional.Int64
}

func (a *V1ClusterControllerApiService) V1ClustersClusterIdPatchAutoHealingConfig(ctx context.Context, clusterId string, localVarOptionals *V1ClusterControllerApiV1ClustersClusterIdPatchAutoHealingConfigOpts) (ClusterDto, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/clusters/{clusterId}/auto-healing-config"
	localVarPath = strings.Replace(localVarPath, "{"+"clusterId"+"}", fmt.Sprintf("%v", clusterId), -1)
