...
rm -rf ~/.terraform.d/plugins/registry.terraform.io/vngcloud/vngcloud/0.0.8
mkdir -p  ~/.terraform.d/plugins/registry.terraform.io/vngcloud/vngcloud/0.0.8/$OS_ARCH
mv terraform-provider-vngcloud ~/.terraform.d/plugins/registry.terraform.io/vngcloud/vngcloud/0.0.8/$OS_ARCH
#terraform init
#terraform apply